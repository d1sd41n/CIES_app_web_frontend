...
import CreateUserForm from "../../components/InputForms/createUserForm";
// Redux store
        ...
        <Card>
          ...
          <CardBody>
            ...
            <Button variant="contained" color="primary" className={style.button} 
                  onClick={() => { props.history.push('/admin/usuarios'); }}>
              Volver
            </Button>
            <CreateUserForm
            url={"/core/companies/"+localStorage.getItem('company_id')+"/seats/"+localStorage.getItem('seat_id')+"/users/"}/>
          </CardBody>
        </Card>
      </GridItem>
    </GridContainer>
